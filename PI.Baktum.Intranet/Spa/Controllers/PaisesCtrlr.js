...
/// Paises
///---------------
yumKaaxControllers.controller("PaisesCtrlr",
            ...
            .then(
                function (result) {
                    if (result.data.Succeeded) {
                        feedbackSrvc.showAlertInfo("pais ha sido grabado correctamente...");
                    }
                    else {
                        feedbackSrvc.showAlertInfo("Error al intentar grabar el pais...consulte al admin del sistema");
                    }
                },
                function (error) {
